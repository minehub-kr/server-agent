package kr.minehub.servers.agent.api.auth;
...
public class MinehubAuthorization {
    ...
    public MinehubAuthorization(String clientId) {
        this(clientId, null);
    }

    public MinehubAuthorization(String clientId, String clientSecret) {
